...
public class AdminMessage extends Message implements Comparable<Message> {
    ...
    public AdminMessage(char[] chars) {
    ...
    public AdminMessage(String raw) {
        fullMessage = raw;
    ...
    public int compareTo(Message messageRework) {
        AdminMessage admin = (AdminMessage) messageRework;
        int returnNum = 0;
        if (this.senderID < admin.senderID) {
            returnNum = 1;
        }
        return returnNum;
    }
